...
product(X::VectorSpaceObject, Y::VectorSpaceObject) = direct_sum(X,Y, projections)[[1,3]]
coproduct(X::VectorSpaceObject, Y::VectorSpaceObject) = direct_sum(X,Y, injections)[[1,2]]
